...
require('TFFramework.client.system.components.TFLabel2')
...
require('TFFramework.client.system.components.TFSkeleton')
...
require('TFFramework.client.system.components.TFClippingNode')
require('TFFramework.client.system.components.TFSpine')
