...
function TFLuaOcJava.enableScreenAutoRotate(autoRotate)
    ...
    elseif CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID then
        TFLuaOcJava.callStaticMethod("org/cocos2dx/TerransForce/TerransForce","enableScreenAutoRotate",{autoRotate})
    end
end
...
function TFLuaOcJava.setScreenOrientation(orientation)
    ...
    elseif CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID then
        TFLuaOcJava.callStaticMethod("org/cocos2dx/TerransForce/TerransForce","setScreenOrientation",{orientation})
    end
end
