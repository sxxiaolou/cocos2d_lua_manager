...
-- setmetatable(tMEIconLabel, require("TFFramework.Editor.EditorBase.EditorBase_LoadTFPanel"))
...
function tMEIconLabel:setTextVAlign(szId, tParams)
	print("setTextVAlign")
	targets[szId]:setTextVerticalAlignment(tParams.nType)
	print("setTextVAlign success")
end

function tMEIconLabel:setTextHAlign(szId, tParams)
	print("setTextHAlign")
	targets[szId]:setTextHorizontalAlignment(tParams.nType)
	print("setTextHAlign success")
end
