...
setFuncs["TFWidget"] = {
	...
	['DiyPropertyViewModel']= function(obj, val) if val and type(val) == 'table' then obj.UIEditorData = val; for k, v in pairs(val) do obj[k] = v end end end,
...
setFuncs["CCClippingNode"]  = setmetatable({}, setFuncs["TFWidget"])
setFuncs["SkeletonAnimation"]  = setmetatable({}, setFuncs["TFWidget"])
