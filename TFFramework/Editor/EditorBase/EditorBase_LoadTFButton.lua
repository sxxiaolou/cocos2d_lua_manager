...
function tMEButton:useOutline(szId, tParams)
	print("setUseOutline")
	targets[szId]._useOutline = tParams.bRet
	if targets[szId]._useOutline then
		targets[szId]:setFontStrokeEnabled(targets[szId]._outLineColor, targets[szId]._outLineSize)
	else
		targets[szId]:setFontStrokeDisabled()
	end
	print("setUseOutline success")
end	

function tMEButton:setOutlineColor(szId, tParams)
...
function tMEButton:setOutlineSize(szId, tParams)
...
function tMEButton:useShadow(szId, tParams)
	print("setUseShadow")
	targets[szId]._useShadow = tParams.bRet
	if targets[szId]._useShadow then
		targets[szId]:setFontShadowEnabled(targets[szId]._shadowColor, targets[szId]._shadowSize)
	else
		targets[szId]:setFontShadowDisabled()
	end
	print("setUseShadow success")
end	

function tMEButton:setShadowColor(szId, tParams)
...
function tMEButton:setShadowSize(szId, tParams)
	print("setShadowSize")
