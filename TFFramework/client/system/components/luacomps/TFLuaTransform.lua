...
function TFLuaTransform:set__x(posX)
	self.gameObject:setPositionXImt(posX)
end

function TFLuaTransform:get__x()
	return self.gameObject:getPositionXImt()
end

function TFLuaTransform:set__y(posY)
	self.gameObject:setPositionYImt(posY)
end

function TFLuaTransform:get__y()
	return self.gameObject:getPositionYImt()
end

function TFLuaTransform:set__z(posZ)
	self.gameObject:setPositionZ(posZ)
end

function TFLuaTransform:get__z()
