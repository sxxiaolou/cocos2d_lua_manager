...
VisibleRect.s_visibleRect = ccr(0, 0, 0, 0)
...
function VisibleRect:getVisibleRect()
    self:lazyInit()
    return ccr(self.s_visibleRect.origin.x, self.s_visibleRect.origin.y, self.s_visibleRect.size.width, self.s_visibleRect.size.height)
end
