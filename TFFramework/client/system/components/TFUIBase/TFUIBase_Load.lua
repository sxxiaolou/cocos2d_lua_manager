...
require('TFFramework.client.system.components.TFUIBase.TFUIBase_LoadTFClippingNode')
require('TFFramework.client.system.components.TFUIBase.TFUIBase_LoadMESpine')
